...
int main(int argc, char *argv[]) {
    ...
    SDL_Surface *surf;
    int bg_w = 0, bg_h = 0;
    const char *fish_names[10] = {"fish-angel.png", "fish-butterfly.png", "fish-flounder.png", "fish-guppy.png", "fish-jelly.png", "fish-minnow.png", "fish-red.png", "fish-seahorse.png", "fish-sprite.png", "fish-striped.png"};
    for (int i = 0; i < 10; i++) {
