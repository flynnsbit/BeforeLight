...
Screensaver savers[] = {
    {"starrynight",
     ...
     ""},
    {"starfield_multilayer",
     "⭐",
     "Multi-Layer Stars",
     "Multi-tiered starfield with depth perception.\n\nStars move at different velocities creating a\nlayered space effect with smooth parallax animation.",
     ""},
    {"starfield_accumulation",
     "⭐",
     "Accumulating Stars",
     "Individual star lifecycles with natural fade effects.\n\nEach star lives 15-45 seconds, fading smoothly\nwithout screen artifacts or jarring transitions.",
     ""},
    {"starfield_trails",
     "⭐",
     "Star Trails",
     "Fast-moving stars with glowing motion trails.\n\nCreates sweeping light trails with low-opacity\naccumulation for smooth, cinematic star motion.",
     ""},
    {"starsclean",
     "⭐",
     "Static Stars",
     ...
     ""},
    {"static_flickering_stars",
     "⭐",
     "Flickering Stars",
     "Realistic night sky with independent flickering.\n\nEach star follows sinusoidal brightness variation,\naccurately mimicking atmospheric twinkling.",
     ""},
    {"fadeout",
     "🌫️",
     "Clouds",
